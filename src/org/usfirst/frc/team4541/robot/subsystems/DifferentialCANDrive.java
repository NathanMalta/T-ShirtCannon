 ...
 */
public class DifferentialCANDrive extends RobotDriveBase {
  public static final double kDefaultQuickStopThreshold = 0.2;
  public static final double kDefaultQuickStopAlpha = 0.1;

  private static int instances = 0;

  private SpeedController m_leftMotor1;
  private SpeedController m_leftMotor2;
  private SpeedController m_rightMotor1;
  private SpeedController m_rightMotor2;
   ...
   */
  public DifferentialCANDrive(SpeedController leftMotor1, SpeedController leftMotor2, SpeedController rightMotor1, SpeedController rightMotor2) {
    m_leftMotor1 = leftMotor1;
    m_leftMotor2 = leftMotor2;
    m_rightMotor1 = rightMotor1;
    m_rightMotor2 = rightMotor2;
    addChild(m_leftMotor1);
    addChild(m_leftMotor2);
    addChild(m_rightMotor1);
    addChild(m_rightMotor2);
    instances++;
  ...
  public void arcadeDrive(double xSpeed, double zRotation, boolean squaredInputs) {
    ...
    m_leftMotor1.set(limit(leftMotorOutput) * m_maxOutput);
    m_leftMotor2.set(limit(leftMotorOutput) * m_maxOutput);
    m_rightMotor1.set(-limit(rightMotorOutput) * m_maxOutput);
    m_rightMotor2.set(-limit(rightMotorOutput) * m_maxOutput);
  ...
  public void curvatureDrive(double xSpeed, double zRotation, boolean isQuickTurn) {
    ...
    m_leftMotor1.set(leftMotorOutput * m_maxOutput);
    m_leftMotor2.set(leftMotorOutput * m_maxOutput);
    m_rightMotor1.set(-rightMotorOutput * m_maxOutput);
    m_rightMotor2.set(-rightMotorOutput * m_maxOutput);
  ...
  public void tankDrive(double leftSpeed, double rightSpeed, boolean squaredInputs) {
    ...
    m_leftMotor1.set(leftSpeed * m_maxOutput);
    m_leftMotor2.set(leftSpeed * m_maxOutput);
    m_rightMotor1.set(-rightSpeed * m_maxOutput);
    m_rightMotor2.set(-rightSpeed * m_maxOutput);
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.addDoubleProperty("Left Motor Speed", m_leftMotor1::get, m_leftMotor1::set);
    builder.addDoubleProperty(
        "Right Motor Speed",
        () -> -m_rightMotor1.get(),
        x -> m_rightMotor1.set(-x));
  }
}
